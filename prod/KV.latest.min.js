...
KV.get_available_providers=function(){var a=[];"string"==typeof KV._infuraID&&a.push("walletconnect");"object"==typeof window.ethereum&&window.ethereum.isMetaMask&&a.push("metamask");"object"==typeof window.BinanceChain&&a.push("binancewallet");return a};KV.set_provider=function(a){switch(a){case "metamask":case "walletconnect":case "binancewallet":case "readonly":KV._provider_name=a;localStorage.setItem("provider_name",a);break;default:throw Exception("Invalid provider specified");}};
KV.get_provider=function(){return KV._provider_name};
